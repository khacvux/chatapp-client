...
import { IFriend, IFriendStore, INotify, IUser } from "../../../core/dtos";
...
const Notify = ({ item }: { item: INotify }) => {
  return (
    <div className="w-full ld:w-[488px] px-3 py-2 flex flex-row items-center space-x-[10px]">
      ...
      <div className="flex flex-col items-center space-x-[8px] w-full">
        ...
        >
          <span className="font-medium mr-1">{item?.user.info.username}</span>{" "}
